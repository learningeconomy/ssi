...
impl Fail for PoKVCErrorKind {}

impl fmt::Display for PoKVCErrorKind {
    fn fmt(&self, f: &mut Formatter<'_>) -> fmt::Result {
        match self {
            Self::UnequalNoOfBasesExponents { bases, exponents } => write!(
                f, "Same no of bases and exponents required. {} bases and {} exponents",
                bases, exponents
            ),
            Self::GeneralError { msg } => write!(f, "Error with message {:?}", msg),
        }
    }
}
