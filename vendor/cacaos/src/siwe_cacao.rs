...
mod payload_ipld {
    ...
    impl Encode<DagCborCodec> for TmpPayload {
        cacao_map_codec!(
            aud: "aud", exp: "exp" = None, iat: "iat", iss: "iss", nbf: "nbf" = None,
            nonce: "nonce", domain: "domain", version: "version",
            request_id: "requestId" = None, resources: "resources", statement: "statement" = None,
        );
    }

    impl Decode<DagCborCodec> for TmpPayload {
        cacao_map_decode!(
            aud: "aud", exp: "exp" = None, iat: "iat", iss: "iss", nbf: "nbf" = None,
            nonce: "nonce", domain: "domain", version: "version",
            request_id: "requestId" = None, resources: "resources", statement: "statement" = None,
    ...
    impl Encode<DagCborCodec> for DummyHeader {
        cacao_map_codec!(t: "t");
    }
    impl Decode<DagCborCodec> for DummyHeader {
        cacao_map_decode!(t: "t");
    }
...
impl Encode<DagCborCodec> for DummySig {
    cacao_map_codec!(s: "s", t: "t");
}

impl Decode<DagCborCodec> for DummySig {
    cacao_map_decode!(s: "s", t: "t");
}
